...
#define X2_MAX_POS 350    // set maximum to the distance between toolheads when both heads are homed
...
#ifdef ULTIPANEL
#define MANUAL_FEEDRATE {80*60, 80*60, 400, 60}  // set the speeds for manual moves (mm/min)
#endif
