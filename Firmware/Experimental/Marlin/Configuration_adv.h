...
#define DUAL_X_CARRIAGE
  ...
  // Note: the first x-carriage is defined4.75 as the x-carriage which homes to the minimum endstop;
  // the second x-carriage always homes to the maximum endstop.
  #define X2_MIN_POS 15     // set minimum to ensure second x-carriage doesn't hit the parked first X-carriage
  #define X2_MAX_POS 365    // set maximum to the distance between toolheads when both heads are homed
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE {80*60, 80*60, 15*60, 300} // Feedrates for manual moves along X, Y, Z, E from panel
